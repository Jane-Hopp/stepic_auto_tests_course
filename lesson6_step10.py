#Проверяющему привет и хорошего настроения :)
#Тут прописаны сразу две ссылки, при работе программы одна из них должна быть закомментированна!
...
try:
    link = "http://suninjuly.github.io/registration1.html" #ссылка на страницу БЕЗ бага
    #link = "http://suninjuly.github.io/registration2.html" #ссылка на страницу с багом
